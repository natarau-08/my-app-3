...
import '../../floor/raw/report_ct_sql.dart';
...
class _ReportCtState extends State<ReportCt> {
  ...
  void initState() {
    ...
    _month = now.month;
    _year = now.year;
    _future = ReportCtSql.reportCtMonthly(_year, _month);
    super.initState();
  }
        ...
        IconButton(
          onPressed: () async {
            ...
            setState(() {
              _year = year;
              _month = month;
              _future = ReportCtSql.reportCtMonthly(year, month);
            });
          },
